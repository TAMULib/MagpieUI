<a name="readme-top"></a>
# Scanned Document Metadata Assignment Tool UI Deployment Guide

## Production Deployments

For **production** deployments, deploy using `docker-compose` via the [Scanned Document Metadata Assignment Tool App][app-repo].
This is the recommended method of deployment for production systems.
Go to the [Scanned Document Metadata Assignment Tool App][app-repo] and following the deployment instructions there.

Performing the deployment using the [Scanned Document Metadata Assignment Tool App][app-repo] should be something similar to the following:
```shell
docker-compose up
```
...
For production deployment, please use `docker-compose` via the [Scanned Document Metadata Assignment Tool App][app-repo] or use the **Docker** method above.
